...
class MyCallBack(Callback):
    ...
    def on_epoch_begin(self, epoch, logs=None):
        if epoch == 0:
            ...
            K.set_value(self.loss_weight["classifier"], 50)
...
class VAE:
    ...
    def compile(self, learning_rate=0.0001):
        ...
        self.model.compile(optimizer=optimizer,
                           loss={
                               ...
                               "classifier": self._calculate_classification_loss
                           },
    ...
    def train(self, x_tr, y_tr, c_tr, x_val, y_val, c_val , batch_size, num_epochs):
        history = self.model.fit([x_tr, c_tr],
                                 ...
                                 epochs=num_epochs,
                                 validation_data=([x_val, c_val], [x_val, x_val, y_val]),
